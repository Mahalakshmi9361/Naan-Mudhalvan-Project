...
# Model Prediction function (Handles KeyError)
def get_predicted_value(patient_symptoms):
    input_vector = np.zeros(len(symptoms_dict))
    
    for item in patient_symptoms:
        if item not in symptoms_dict:  # Check if the symptom exists in the dictionary
            return "Invalid symptom entered. Please check your input."
...
def home():
    if request.method == 'POST':
        try:
            ...
            error_message = "Invalid input! Please enter valid symptoms."
